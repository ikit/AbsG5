    ...
    <div class="container">
        ...
        <v-card>
            ...
            <ul>
                ...
                <li>Tagueule: <a href="https://avatar.absolumentg.fr" target="_blank">Editeur d'avatar</a></li>
            </ul>
        </v-card>
        ...
        <v-card>
            <ul>
                <li>Initialisation du projet et choix des technologies la technologie VueJs et Vuetify:
                    <ul>
                        <li>DB: postgreSQL</li>
